...
def test_logout(page: Page):
    """14. Test logging out from Manager dashboard and verify browser Back button access is blocked."""
    ...
    _screenshot(page, "test_14_logout_success")
    ...
    _screenshot(page, "test_14_logout_back_button_blocked")
