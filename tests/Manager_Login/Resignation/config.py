...
def login_and_navigate_to_resignation(page, role="Manager"):
    ...
    # Wait for dashboard to load and click Resignation directly
    page.wait_for_timeout(3000)
    page.locator("div").filter(has_text=re.compile(r"^Resignation$")).locator("svg").first.click()
    
    # Fallback if svg click doesn't work:
    # page.get_by_role("button", name="Resignation").click()
