...
def test_edit_holiday(page: Page) -> None:
    ...
    page.get_by_role("row", name="Algeria West Goa South").get_by_role("button").first.click()
    ...
    page.get_by_placeholder("Occasion", exact=True).fill("testing-pongallll")
